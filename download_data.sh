#!/bin/bash
# Downloads a given problem dataset from Advent of Code 2022
...
p=$(printf "%02d\n" $1);
curl "https://adventofcode.com/2022/day/$1/input" --cookie "session=$ADVENT_OF_CODE_SESSION_KEY" > "./data/p$p.txt"
